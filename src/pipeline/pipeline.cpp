...
namespace BlockyVulkan {
    ...
    void Pipeline::CreateGraphicsPipeline(const std::string &vertFilePath,
        ...
        assert(configInfo.pipelineLayout != VK_NULL_HANDLE &&
            "Cannot create graphics pipeline: No pipelineLayout provided! (at "
            "configInfo)");
        assert(configInfo.renderPass != VK_NULL_HANDLE &&
            "Cannot create graphics pipeline: No renderPass provided! (at "
            "configInfo)");
    ...
    void Pipeline::DisableAlphaBlending(PipelineConfigInfo &configInfo) {
        configInfo.colorBlendAttachment.blendEnable = VK_FALSE;
    }
}
